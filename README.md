...
## Adding shuffle-deck design photos (home page)

The "Multiple Designs, One Studio" section has a tap-to-shuffle card deck
with 5 empty placeholder slots. To add a real photo, upload an image with
the exact matching filename next to `index.html`:

```
style-01.jpg ... style-05.jpg   → 5 shuffle deck slots
```

Recommended: square-ish images, at least 700×500px, `.jpg`.
